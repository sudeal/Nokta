...
const Template10 = ({ business, colorScheme }) => {
  // Template 10: Messaging and menu prices features enabled
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.templateInfo}>
          <Text style={styles.templateText}>Template 10: Messaging & Menu Website</Text>
          <Text style={styles.templateFeatures}>Messaging and Menu Prices features enabled</Text>
        </View>
      </View>
