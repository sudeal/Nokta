...
const Template11 = ({ business, colorScheme }) => {
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.templateInfo}>
          <Text style={styles.templateText}>Template 11: Messaging & Statistics Website</Text>
          <Text style={styles.templateFeatures}>Messaging and Statistics features enabled</Text>
        </View>
      </View>
