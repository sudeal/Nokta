...
const Template7 = ({ business, colorScheme }) => {
  // Template 7: Statistics and directions features enabled
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.templateInfo}>
          <Text style={styles.templateText}>Template 7: Statistics & Directions Website</Text>
          <Text style={styles.templateFeatures}>Statistics and Directions features enabled</Text>
        </View>
      </View>
    </ScrollView>
  );
