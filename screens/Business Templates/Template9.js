...
const Template9 = ({ business, colorScheme }) => {
  // Template 9: Messaging and directions features enabled
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.templateInfo}>
          <Text style={styles.templateText}>Template 9: Messaging & Directions Website</Text>
          <Text style={styles.templateFeatures}>Messaging and Directions features enabled</Text>
        </View>
      </View>
