...
const Template14 = ({ business, colorScheme }) => {
  // Template 14: Messaging, statistics, and menu prices features enabled
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.templateInfo}>
          <Text style={styles.templateText}>Template 14: Multi-Feature Website</Text>
