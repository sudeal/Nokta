...
const Template6 = ({ business, colorScheme }) => {
  // Template 6: Menu prices and directions features enabled
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.templateInfo}>
          <Text style={styles.templateText}>Template 6: Menu & Directions Website</Text>
          <Text style={styles.templateFeatures}>Menu Prices and Directions features enabled</Text>
        </View>
      </View>
    </ScrollView>
  );
