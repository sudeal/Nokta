...
const Template13 = ({ business, colorScheme }) => {
  // Template 13: Messaging, menu prices, and directions features enabled
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.templateInfo}>
          <Text style={styles.templateText}>Template 13: Multi-Feature Website</Text>
          <Text style={styles.templateFeatures}>Messaging, Menu Prices, and Directions features enabled</Text>
        </View>
      </View>
