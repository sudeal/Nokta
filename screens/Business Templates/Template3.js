...
const Template3 = ({ business, colorScheme }) => {
  // Template 3: Only menu prices feature is enabled
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.templateInfo}>
          <Text style={styles.templateText}>Template 3: Menu Website</Text>
          <Text style={styles.templateFeatures}>Only Menu Prices feature is enabled</Text>
        </View>
      </View>
    </ScrollView>
  );
