...
const Template4 = ({ business, colorScheme }) => {
  // Template 4: Only statistics feature is enabled
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.templateInfo}>
          <Text style={styles.templateText}>Template 4: Statistics Website</Text>
          <Text style={styles.templateFeatures}>Only Statistics feature is enabled</Text>
        </View>
      </View>
    </ScrollView>
  );
