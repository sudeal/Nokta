...
const Template5 = ({ business, colorScheme }) => {
  // Template 5: Only messaging feature is enabled
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.templateInfo}>
          <Text style={styles.templateText}>Template 5: Messaging Website</Text>
          <Text style={styles.templateFeatures}>Only Messaging feature is enabled</Text>
        </View>
      </View>
